...
- `site/` — the public website (brand-general landing page + per-topic sections), deployed to Cloudflare Pages. See [`site/README.md`](site/README.md).
...
- [ ] SEO glossary (`/airlines/`, later `/hotels/`, `/attractions/`) — planned, not built. Singapore-scoped, airlines first.
