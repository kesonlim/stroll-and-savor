...
- [~] SEO glossary — `/airlines/` tier 1 live (15 Star Alliance members flying to/from Changi, including SIA itself). Tiers 2+ (other alliance/codeshare partners, then the remaining ~71 of Changi's 86 airlines) and `/hotels/`, `/attractions/` not started.
